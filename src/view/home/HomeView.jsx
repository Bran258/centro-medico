...
import SeasonalPromo from "../../components/SeasonalPromo.jsx";
  ...
  return (
    <>
      <main className="home-container bg-white">
        ...
        {/* 1. NAVEGACIÓN (Fija arriba) */}
        <Navigation />

        {/* 2. ESPACIO DE SEGURIDAD + PROMOCIÓN */}
        {/* Agregamos marginTop: '76px' para que el Navbar no tape el contenido */}
        <div style={{ marginTop: '76px' }}>
          <SeasonalPromo />
        </div>

        {/* 3. HERO SECTION (El banner principal con la foto) */}
